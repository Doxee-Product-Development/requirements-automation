---
id: "d1bc05fc-3812-4673-aeae-e9cf2e7d676c"
title: "Configuration"
slug: "6-6-process-engine-administration-reference-configuration"
...
version: 2
public_version: 2
created_at: "2025-08-04T10:14:46.075Z"
modified_at: "2025-08-20T18:55:27.795Z"
authors:
  - name: "Migration Team"
    email: "d360migrationteam@kovai.co"
source_url: "https://docs.doxee.com/docs/en/6-6-process-engine-administration-reference-configuration"
synced_at: "2026-01-28T21:01:33.662Z"
checksum: "601d577b54dff345"
---
...
## Key Store Configuration
`&lt;keyStores&gt;` configures key stores to be used if they are required e.g. for authentication. Please refer to [Key Stores](/doxee-platform/docs/6-6-process-engine-administration-reference-key-stores) for details on how to configure key stores.
...
For details on configuring and using a credentials registry, please refer to [Credentials Registry](/doxee-platform/docs/appendix-c-credentials-registry).
...
If you want to keep the logging configuration in a separate file, you can use 	an XInclude directive in the Process Engine configuration. See [XInclude](/doxee-platform/docs/appendix-a-xml-configuration-files#a2-xinclude) for more information.
...
`&lt;attributes&gt;
  ...
  &lt;/attribute&gt;
  ...
&lt;/data&gt;`Each attribute [2] defines a unique name [2] and a type [3] (the available types are the same as those used by the data log, please see [Data Logging](/doxee-platform/docs/6-6-process-engine-administration-reference-configuration#data-logging) above). Additionally, an XPath expression [4] is provided which is evaluated each time the attribute is logged to determine its current value.
...
Maintenance levels may override this behaviour. For details, please see [Maintenance Configuration](/doxee-platform/docs/chapter-3-configuration#323-maintenance-configuration).
...
Please refer to [Service Processes](/doxee-platform/docs/chapter-4-autoexec-processes-services#42-service-processes) for details.
...
Please refer to [Autoexec Processes](/doxee-platform/docs/chapter-4-autoexec-processes-services#41-autoexec-processes) for details.
...
Please refer to [Storage Configuration](/doxee-platform/docs/appendix-d-storage-configuration) for a description of the generic way to configure storage in Doxee applications. The remainder of this section will give additional information on specific Process Engine related settings.
...
A private [6] and a public [7] key have to be configured if the process engine should be able to create tasks that store the credentials of the user who checks them in. They are specified as key references to a configured key store (see [Key Stores](/doxee-platform/docs/appendix-b-key-stores)), e.g.:
...
Maintenance levels can be configured to temporarily restrict the process engine’s functionality. For more details, please see [Maintenance Levels](/doxee-platform/docs/6-6-process-engine-administration-reference-maintenance#maintenance-levels).
...
`&lt;shutdown timeout="30s" hardTimeout="30s" /&gt;`For details, please see [Shutting Down](/doxee-platform/docs/6-6-process-engine-administration-reference-maintenance#shutting-down).
...
This node is required if JNDI should be used to look up the necessary objects. For more information about message clients with JNDI see [JNDI Message Client.](/doxee-platform/docs/6-6-process-engine-administration-reference-configuration#jndi-message-client)
