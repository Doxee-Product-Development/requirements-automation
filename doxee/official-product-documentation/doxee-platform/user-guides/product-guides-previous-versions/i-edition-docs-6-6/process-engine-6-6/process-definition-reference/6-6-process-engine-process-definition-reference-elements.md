---
id: "199e6903-d7fd-4f66-ada4-2cf5a9db3cc8"
title: "Elements"
slug: "6-6-process-engine-process-definition-reference-elements"
...
version: 2
public_version: 2
created_at: "2025-08-06T12:29:51.92Z"
modified_at: "2025-08-20T17:30:50.97Z"
authors:
  - name: "Migration Team"
    email: "d360migrationteam@kovai.co"
source_url: "https://docs.doxee.com/docs/en/6-6-process-engine-process-definition-reference-elements"
synced_at: "2026-01-28T21:01:23.778Z"
checksum: "ed64250d65e3143e"
---
...
A number of conditions (see [Condition](/doxee-platform/docs/6-6-process-engine-process-definition-reference-elements#condition)).
...
Like with a [Wait Element](/doxee-platform/docs/6-6-process-engine-process-definition-reference-elements#wait-element), the process will change its state to waiting while `waiting` for the task to be finished.
...
collectIterationResults::See [Group](/doxee-platform/docs/6-6-process-engine-process-definition-reference-elements#group). Unlike for groups, this flag defaults to `true` for include elements.
