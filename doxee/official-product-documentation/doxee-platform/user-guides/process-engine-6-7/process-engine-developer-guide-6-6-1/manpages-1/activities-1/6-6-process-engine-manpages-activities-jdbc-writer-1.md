---
id: "247c739d-a54c-43b3-b4d6-ce1818bc231f"
title: "JDBC Writer"
slug: "6-6-process-engine-manpages-activities-jdbc-writer-1"
...
version: 1
public_version: 1
created_at: "2026-01-07T13:42:14.086Z"
modified_at: "2026-01-07T14:06:50.05Z"
authors:
  - name: "Dominika Kassovicova"
    email: "dkassovicova@doxee.com"
source_url: "https://docs.doxee.com/docs/en/6-6-process-engine-manpages-activities-jdbc-writer-1"
synced_at: "2026-01-28T20:55:37.529Z"
checksum: "03fb6985479b15b2"
---
...
(jdbcWriter, Module: [Base](/doxee-platform/docs/6-6-process-engine-manpages-detailed-module-descriptions-base-1))
...
Deprecated: Use jdbcRunner instead.
...
The call statement, in SQL. This will automatically be wrapped in curly braces for execution. Curly brace parameters inside this statement may specify ":in", ":out", or ":inOut" as parameter types between their name and type e.g. "param:out:string"). If not specified, this flag defaults to "in".
...
Whether the SQL query represents a stored procedure call. If not specified, the value is autodetected by checking if the query begins with a 'call' statement.
...
If activated, the SQL query will automatically be wrapped in a curly brace comment if it is a stored procedure call. Some database systems require this when calling stored procedures. If not specified, the value is determined automatically from the dialect.
